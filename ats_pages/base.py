...
class BasePage(Common):
    ...
    def click_radio_element(self, locator, isYes):
        return self.click_radio(locator, JobData.job_data.get(isYes))

    def click_checkbox_element(self, locator, isCheck):
        return self.click_checkbox(locator, JobData.job_data.get(isCheck))
    ...
    def select_auto_complete_element(self, locator, text):
        return self.click_auto_complete(locator, JobData.job_data.get(text))
