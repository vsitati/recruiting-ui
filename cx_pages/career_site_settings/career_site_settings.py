...
class CareerSiteSettings(Elements, Common):
    ...
    def open_setting(self, setting):
        settings = dict(
            ...
            presubmission_text=partial(self.open_url, self.get_career_site_setting_link(setting="Presubmission Text")),
            fee_agency_presubmission_text=partial(self.open_url, self.get_career_site_setting_link(setting="Fee Agency Presubmission Text")),
            google_integrations=partial(self.open_url, self.get_career_site_setting_link(setting="Google Integrations")),
            ...
            cookie_policy_acknowledgement=partial(self.open_url, self.get_career_site_setting_link(setting="Cookie Policy Acknowledgement")),
            application_form=partial(self.open_url, self.get_career_site_setting_link(setting="Application Form")),
            fee_agency_application_form=partial(self.open_url, self.get_career_site_setting_link(setting="Fee Agency Application Form")),
            ...
            fee_agency_job_details_page=partial(self.open_url, self.get_career_site_setting_link(setting="Fee Agency Job Details Page")),
