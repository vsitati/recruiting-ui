...
class TestQuickApplyVariable:
    @allure.description("Testrails C726 - Quick Apply Variable")
    def test_quick_apply_variable(self, get_test_info):
        language = "english"
