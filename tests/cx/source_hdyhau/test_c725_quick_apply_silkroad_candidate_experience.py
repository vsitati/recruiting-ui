...
class TestQuickApplySilkroadCandidateExperience:
    @allure.description("Testrails C725 - Quick Apply (Silkroad Candidate Experience)")
    def test_quick_apply_silkroad_candidate_experience(self, get_test_info):
        language = "english"
