...
class TestOpenSubmissionQuickApplySilkRoadCandidateExperience:
    @allure.description("Test C712 - Open Submission Quick Apply - SilkRoad Candidate Experience")
    def test_open_submission_quick_apply_silkroad_candidate_experience(self, get_test_info):
        language = "english"
        ...
        assert crp.verify_source() == "SilkRoad Candidate Experience"
