...
class TestQuickApplyExternal:
    ...
    @allure.description("Random Job Quick Apply External - German")
    def test_random_job_quick_apply_external_german(self, get_test_info):
        language = "german"
        login = Login(driver=self.driver)
        login.do_login(env_info=get_test_info)
    ...
    @allure.description("Random Job Quick Apply External - Spanish")
    def test_random_job_quick_apply_external_spanish(self, get_test_info):
        language = "spanish"
        login = Login(driver=self.driver)
        login.do_login(env_info=get_test_info)
