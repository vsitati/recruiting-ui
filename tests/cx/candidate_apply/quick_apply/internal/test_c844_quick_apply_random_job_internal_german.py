...
class TestQuickApplyRandomJobInternalGerman:
    @allure.description("Random Job Quick Apply Internal - German")
    def test_random_job_quick_apply_internal_german(self, get_test_info):
        language = "german"
