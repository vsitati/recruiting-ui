...
class TestQuickApplyRandomJobInternalDefaultPortalLanguageScenario2:
    @allure.description("Random Job Quick Apply Internal Default Portal Language Scenario 2")
    def test_random_job_quick_apply_internal_default_portal_language_scenario2(self, get_test_info):
        language = "english"
