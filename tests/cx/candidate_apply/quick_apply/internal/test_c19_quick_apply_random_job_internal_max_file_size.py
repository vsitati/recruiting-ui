...
class TestQuickApplyRandomJobInternalMaxFileSize:
    @allure.description("Random Job Quick Apply Internal max file size")
    def test_random_job_quick_apply_internal_max_file_size(self, get_test_info):
        language = "english"
        ...
        assert qa.get_file_error() == "Your Resume/CV is too large. Please upload a file smaller than 10 MB."
