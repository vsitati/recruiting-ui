...
class TestAtsSsoLogin:
    ...
    def test_can_login_with_active_sso_user(self, get_test_info):
        username, password = TestData.data[get_test_info.get("company")]["users"]["sso"]
    ...
    def test_cannot_login_with_an_invalid_sso_user(self, get_test_info):
        username, password = TestData.data[get_test_info.get("company")]["users"]["sso_invalid_username"]
        ...
        assert error_msg == TestData.sso_validation.get("sso_invalid_username_error", "")
    ...
    def test_cannot_login_with_an_inactive_sso_user(self, get_test_info):
        username, password = TestData.data[get_test_info.get("company")]["users"]["sso_inactive_username"]
        invalid_credentials = dict(password=password, username=username)
        login = Login(driver=self.driver)
        login.do_login(get_test_info, cred=invalid_credentials, sso=True)
    ...
    def test_cannot_login_with_an_active_sso_disabled_user(self, get_test_info):
        username, password = TestData.data[get_test_info.get("company")]["users"]["sso_disabled_active_username"]
        invalid_credentials = dict(password=password, username=username)
        login = Login(driver=self.driver)
        login.do_login(get_test_info, cred=invalid_credentials, sso=True)
    ...
    def test_cannot_login_with_an_inactive_sso_disabled_user(self, get_test_info):
        username, password = TestData.data[get_test_info.get("company")]["users"]["sso_disabled_inactive_username"]
        invalid_credentials = dict(password=password, username=username)
        login = Login(driver=self.driver)
        login.do_login(get_test_info, cred=invalid_credentials, sso=True)
